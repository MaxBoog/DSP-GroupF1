      ...
      <section className="flex items-center mx-auto rounded justify-center h-full max-w-7xl p-5 m-5 bg-indigo-900">
        <div className="text-gray-100 m-5 grid grid-cols-12 gap-10">
          ...
          <div className="col col-span-12">
            <header>
              <h1>
                Welcome to Data Gem: Revolutionizing Data Sharing in Business
              </h1>
            </header>
            <hr className="my-5" />
          </div>

          <section className="col col-span-12 md:col-span-6">
            <p>
              In the era of information, data is the new currency. At Data Gem,
              we understand the pivotal role data plays in the business world.
              That&apos;s why we&apos;ve created a platform that simplifies the
              way companies manage, share, and utilize their data. Our web
              application is designed to facilitate seamless data integration
              and collaboration between businesses and their suppliers, ensuring
          ...
          <section className="col col-span-12 md:col-span-6">
            ...
            <ul>
              <li className="py-2">
                ...
                ensures your business is quickly onboarded, allowing you to
                begin sharing and receiving data without delay.
              </li>
              <li className="py-2">
              ...
              <li className="py-2">
                ...
                your data seriously. Data Gem employs state-of-the-art
                encryption and compliance measures to ensure your data is
                protected at every step.
              </li>
              <li className="py-2">
                <strong>Real-Time Data Sharing</strong>: Share and receive data
                in real-time. Our platform ensures that you and your suppliers
                are always on the same page, facilitating immediate responses
                and swift decision-making.
              </li>
              <li className="py-2">
                <strong>Collaborative Tools</strong>: Foster stronger
                relationships with your suppliers through our collaborative
                tools. Discuss data insights, resolve discrepancies, and plan
                strategies all within Data Gem.
              </li>
              <li className="py-2">
              ...
              <li className="py-2">
                ...
                business. Whether you&amps;re a small startup or a large
                enterprise, Data Gem scales to meet your data sharing needs.
              </li>
            </ul>
          </section>
          ...
          <section className="col col-span-12 md:col-span-6">
            ...
            <ul>
              <li className="py-2">
                <strong>Enhanced Efficiency</strong>: By streamlining the
                process of data sharing, Data Gem saves you time and resources.
                No more cumbersome email attachments or risky data transfers.
              </li>
              <li className="py-2">
                <strong>Improved Decision Making</strong>: With real-time data
                at your fingertips, make more informed decisions. Understand
                market trends, track supply chain dynamics, and respond to
                challenges swiftly.
              </li>
              <li className="py-2">
              ...
              <li className="py-2">
                ...
                breaches are costly, Data Gem&apos;s robust security measures
                give you peace of mind, knowing your data is in safe hands.
              </li>
            </ul>
          </section>
          ...
          <section className="col col-span-12 md:col-span-6">
            ...
            <p>
              ...
              not just adopting a tool; you&apos;re embracing a future where
              data sharing is seamless, secure, and empowering.
            </p>
          </section>
          ...
          <section className="col col-span-12 md:col-span-6">
            ...
            <p>
              ...
              Contact us at <strong>contact@datagem.com</strong>, and we&apos;ll
